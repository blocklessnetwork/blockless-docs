!(function () {
	...
	var H = (function (o) {
			...
			return (
				o && (e.__proto__ = o),
				(((e.prototype = Object.create(o && o.prototype)).constructor = e).prototype.getBasePath =
					function () {
				...
				(e.prototype.parse = function (e) {
					...
					return (
						...
						{ path: e, file: this.getFile(e, !0), query: F(n) }
					)
				}),
	...
	function G(e) {
		...
		Z || ((e = w('div')).classList.add('progress'), r(h, e), (Z = e)),
			(n = t
				? 80 < (n = parseInt(Z.style.width || 0, 10) + t)
					? 80
					: n
				: Math.floor((i / o) * 100)),
			(Z.style.opacity = 1),
						...
						a('load', function (e) {
							...
							400 <= e.status
								...
								: ((e = W[t] =
										{
											content: e.response,
											opt: { updatedAt: r.getResponseHeader('last-modified') }
										}),
								  n(e.content, e.opt))
						})
				},
	...
	function K() {
		...
		n &&
			...
			window.pageYOffset >= e || n.classList.contains('hidden')
				? S(h, 'add', 'sticky')
				: S(h, 'remove', 'sticky'))
	}
	function ee(e, n, o, i) {
	...
	var nn = (function () {
			...
			return (
							...
							if (((r = n = p[l]), l !== g - 1)) {
								if (
									...
									this.options.pedantic
										? o[1].length > s[1].length
										: o[1].length > s[0].length || 3 < o[1].length)
								) {
									p.splice(l, 2, p[l] + '\n' + p[l + 1]), l--, g--
									continue
								}
				...
				(e.prototype.lheading = function (e) {
					...
					if (e)
						return { type: 'heading', raw: e[0], depth: '=' === e[2].charAt(0) ? 1 : 2, text: e[1] }
				}),
				...
				(e.prototype.codespan = function (e) {
					...
					if (n) {
						var i = n[2].replace(/\n/g, ' '),
							...
							e = /^ /.test(i) && / $/.test(i)
						return (
							o && e && (i = i.substring(1, i.length - 1)),
							(i = Je(i, !0)),
				...
				(e.prototype.autolink = function (e, n) {
					...
					if (e) {
						var i,
							n =
								'@' === e[2]
									? 'mailto:' + (i = Je(this.options.mangle ? n(e[1]) : e[1]))
									: (i = Je(e[1]))
						return {
							type: 'link',
							raw: e[0],
	...
	;(Ze.punctuation = Ve(Ze.punctuation)
		...
		(Ze.autolink = Ve(Ze.autolink)
			.replace('scheme', Ze._scheme)
			.replace('email', Ze._email)
			.getRegex()),
		(Ze._attribute = /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/),
		(Ze.tag = Ve(Ze.tag)
			.replace('comment', Ze._comment)
			.replace('attribute', Ze._attribute)
			.getRegex()),
		(Ze._label = /(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/),
		(Ze._href = /<(?:\\.|[^\n<>\\])+>|[^\s\x00-\x1f]*/),
		(Ze._title = /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/),
	...
	function un(e) {
		for (var n, i = '', o = e.length, t = 0; t < o; t++)
			(n = e.charCodeAt(t)),
				(i += '&#' + (n = 0.5 < Math.random() ? 'x' + n.toString(16) : n) + ';')
		return i
	}
	var fn = (function () {
			function i(e) {
			...
			return (
				...
				(i.prototype.inlineTokens = function (e, n, i, o) {
					...
					for (; e; )
						if ((r || (c = ''), (r = !1), (t = this.tokenizer.escape(e))))
				...
				(e.prototype.code = function (e, n, i) {
					...
					return (
						!this.options.highlight ||
							(null != (n = this.options.highlight(e, o)) && n !== e && ((i = !0), (e = n))),
						(e = e.replace(/\n$/, '') + '\n'),
						o
							? '<pre><code class="' +
			...
			return (
				...
				(e.prototype.getNextSafeSlug = function (e, n) {
					...
					if (this.seen.hasOwnProperty(i))
						for (o = this.seen[e]; (i = e + '-' + ++o), this.seen.hasOwnProperty(i); );
		...
		mn = (function () {
			...
			return (
				...
				(i.prototype.parse = function (e, n) {
					void 0 === n && (n = !0)
					for (
						var i, o, t, a, r, c, u, f, p, d, g, s, l, v, h, _ = '', m = e.length, b = 0;
						b < m;
						b++
					)
						switch ((f = e[b]).type) {
							...
							case 'table':
								...
								for (
									p += this.renderer.tablerow(c), u = '', t = f.cells.length, i = 0;
									i < t;
									i++
								) {
							...
							case 'list':
								for (
									p = f.ordered, k = f.start, d = f.loose, t = f.items.length, u = '', i = 0;
									i < t;
									i++
								)
							...
							case 'text':
								for (
									u = f.tokens ? this.parseInline(f.tokens) : f.text;
									b + 1 < m && 'text' === e[b + 1].type;
					...
					'code' === i.type &&
						...
						setTimeout(function () {
							a(i.text, i.lang, function (e, n) {
								return e
									? r(e)
									: (null != n && n !== i.text && ((i.text = n), (i.escaped = !0)),
									  void (0 === --c && r()))
							})
						}, 0))
				}),
	...
	var Sn = (xn.parse = xn)
	function An(e, i) {
		if ((void 0 === i && (i = '<ul class="app-sub-sidebar">{inner}</ul>'), !e || !e.length))
			return ''
		var o = ''
		return (
			e.forEach(function (e) {
									...
									r.grammar
										? n && u.Worker
											? (((n = new Worker(R.filename)).onmessage = function (e) {
											  ...
											  n.postMessage(
													JSON.stringify({ language: r.language, code: r.code, immediateClose: !0 })
											  ))
														...
														if (!(b instanceof T)) {
															...
															if (l) {
																...
																for (S += _.value.length; S <= y; )
																	(_ = _.next), (S += _.value.length)
																if (((S -= _.value.length), (m = S), _.value instanceof T)) continue
																for (
																	var A = _;
																	A !== i.tail && (S < x || 'string' == typeof A.value);
																	A = A.next
																)
																	w++, (S += A.value.length)
					...
					if (
						...
						(T.stringify = function n(e, i) {
							...
							var t = {
								...
								e = e.alias
							e &&
								(Array.isArray(e) ? Array.prototype.push.apply(t.classes, e) : t.classes.push(e)),
								R.hooks.run('wrap', t)
							var a,
								r = ''
	...
	function In(t, e) {
		...
		var r = o((e = t.markdown || {}))
			? e(Sn, n)
			: (Sn.setOptions(m(e, { renderer: m(n, e.renderer) })), Sn)
		;(this._marked = r),
	...
	;(In.prototype.compileEmbed = function (e, n) {
		...
		(In.prototype._initRenderer = function () {
			...
			return (
				(t.heading = e.heading =
					function (e, n) {
						...
						;/<!-- {docsify-ignore} -->/g.test(o) &&
							((o = o.replace('\x3c!-- {docsify-ignore} --\x3e', '')),
							(e.title = On(o)),
							(e.ignoreSubHeading = !0)),
							/{docsify-ignore}/g.test(o) &&
								((o = o.replace('{docsify-ignore}', '')),
								(e.title = On(o)),
								(e.ignoreSubHeading = !0)),
							/<!-- {docsify-ignore-all} -->/g.test(o) &&
								((o = o.replace('\x3c!-- {docsify-ignore-all} --\x3e', '')),
								(e.title = On(o)),
								(e.ignoreAllSubs = !0)),
							/{docsify-ignore-all}/g.test(o) &&
								((o = o.replace('{docsify-ignore-all}', '')),
								(e.title = On(o)),
								(e.ignoreAllSubs = !0))
				...
				(t.code = { renderer: e }.renderer.code =
					function (e, n) {
				...
				(t.link =
					((i = (n = { renderer: e, router: a, linkTarget: n, linkRel: i, compilerClass: g })
						.renderer),
					(c = n.router),
					(u = n.linkTarget),
					n.linkRel,
				...
				(t.paragraph = { renderer: e }.renderer.paragraph =
					function (e) {
						e = /^!&gt;/.test(e)
							? $n('tip', e)
							: /^\?&gt;/.test(e)
				...
				(t.list = { renderer: e }.renderer.list =
					function (e, n, i) {
						n = n ? 'ol' : 'ul'
						return (
							'<' +
							...
							' ' +
							[
								/<li class="task-list-item">/.test(e.split('class="task-list"')[0])
									? 'class="task-list"'
									: '',
								i && 1 < i ? 'start="' + i + '"' : ''
							]
				...
				(t.listitem = { renderer: e }.renderer.listitem =
					function (e) {
					  ...
					  (o = i).replace(V, function (n, e, i) {
							a.push(o.substring(r, i - 1)),
								...
								a.push(
									(t && t[n]) ||
										function (e) {
											return ('00' + ('string' == typeof Y[n] ? e[Y[n]]() : Y[n](e))).slice(
												-n.length
											)
										}
								)
	...
	function Gn(e) {
		...
		if (
			...
			2 === t &&
				...
				!Un &&
					i.vueGlobalOptions &&
					'function' == typeof i.vueGlobalOptions.data &&
					(Un = i.vueGlobalOptions.data()),
				p.push.apply(
					p,
	...
	var Qn,
		Jn = (function (e) {
			...
			return (
				e && (n.__proto__ = e),
				(((n.prototype = Object.create(e && e.prototype)).constructor = n).prototype.initPlugin =
					function () {
						var n = this
			...
			(function (e) {
				...
				return (
					e && (n.__proto__ = e),
					(((n.prototype = Object.create(e && e.prototype)).constructor =
						n).prototype._loadSideAndNav = function (e, n, i, o) {
						var t = this
						return function () {
							if (!i) return o()
							Wn(
				...
				(function (e) {
					...
					return (
						e && (n.__proto__ = e),
						(((n.prototype = Object.create(e && e.prototype)).constructor =
							n).prototype.$resetEvents = function (e) {
							var n = this,
							...
							'history' !== e &&
								...
								'navigate' === e &&
									i &&
									((i = i), (_e.scrollTop = !0 === (i = void 0 === i ? 0 : i) ? 0 : Number(i)))),
					...
					(function (e) {
						...
						return (
							e && (n.__proto__ = e),
							(((n.prototype = Object.create(e && e.prototype)).constructor =
								n).prototype._renderTo = function (e, n, i) {
								e = l(e)
							...
							(n.prototype._renderSidebar = function (e) {
								...
								t && i
									? (i.parentNode.innerHTML += this.compiler.subSidebar(o) || '')
								...
								u
									? (e.repo &&
											(f +=
												...
												t
													? '<a href="' +
													  (t = (t = !/\/\//.test(t) ? 'https://github.com/' + t : t).replace(
															/^git\+/,
															''
													  )) +
													  '" target="' +
									...
									e.themeColor &&
										(v.head.appendChild(
											w('div', '<style>:root{--theme-color: ' + e.themeColor + ';}</style>')
												.firstElementChild
										),
										(a = e.themeColor),
						...
						(function (e) {
							...
							return (
								...
								(n.prototype.matchVirtualRoute = function (t) {
									...
									function u() {
										var e = r.shift()
										if (!e) return c(null)
										var n = A((o = ((i = '^'), 0 === (o = e).indexOf(i) ? o : '^' + o)), '$')
												? o
												: o + '$',
											i = t.match(n)
										if (!i) return u()
							...
							(function (i) {
								...
								return (
									i && (e.__proto__ = i),
									(((e.prototype = Object.create(i && i.prototype)).constructor =
								...
								(function (e) {
									...
									return (
										e && (n.__proto__ = e),
										(((n.prototype = Object.create(e && e.prototype)).constructor =
											n).prototype.initLifecycle = function () {
											var i = this
											;(this._hooks = {}),
												(this._lifecycle = {}),
												['init', 'mounted', 'beforeEach', 'afterEach', 'doneEach', 'ready'].forEach(
													function (e) {
														var n = (i._hooks[e] = [])
